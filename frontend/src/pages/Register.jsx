...
export default function Register() {
  ...
  return (
    <PageTransition className="mx-auto flex max-w-md flex-col px-6 py-16">
      ...
      >
        <div className="mb-6">
          <h1 className="text-2xl font-bold tracking-tight text-ink-50">Create your account</h1>
          {/* <p className="mt-1 text-sm text-ink-400">
            Start mapping your skills and setting SMART targets.
          </p> */}
        </div>

        <div className="space-y-4">
          <div>
            <label htmlFor="fullName" className="label mb-1.5 block">
              Full name
            </label>
            <input
              id="fullName"
          ...
          <div>
            ...
            />
            <p className="mt-1.5 text-xs text-ink-500">Minimum 8 characters.</p>
          </div>
        </div>
